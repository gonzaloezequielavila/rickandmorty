...
It was first made with the intention to learn Front End, using the basics (CSS, HTML) and then adding React. We use the Rick and Morty API as a database and 
